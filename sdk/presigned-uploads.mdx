...
if not upload.success then
    print(("FiveMesh upload URL failed: %s"):format(upload.error.message))
    return
end
...
if not result.success then
    print(("FiveMesh presigned upload failed: %s"):format(result.error.message))
    return
end
